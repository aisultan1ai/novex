...
На текущем этапе проект находится в стадии **запускаемого skeleton**; уже заложены структура репозитория, инфраструктурный контур и базовые точки входа для дальнейшей разработки.
